...
const TYPE_TO_I18N_KEY: Record<string, string> = {
  ...
  'capsule.generated': 'capsuleGenerated',
};
    ...
    (notification: NotificationResponse): string => {
      ...
      if (i18nKey) {
        try {
          ...
          const result = t(`types.${i18nKey}.title`, params);
          if (result.startsWith('notifications.types.')) return notification.title;
          return result;
        } catch {
                  ...
                  <div className="min-w-0 flex-1">
                    <Tooltip>
                      ...
                      <TooltipContent side="bottom" className="max-w-xs">
                        <p className="text-xs">{getTitle(notification)}</p>
                      </TooltipContent>
                    </Tooltip>
                    <Tooltip>
                      <TooltipTrigger asChild>
                      ...
                      <TooltipContent side="bottom" className="max-w-xs">
                        <p className="text-xs">{getMessage(notification)}</p>
                      </TooltipContent>
                    </Tooltip>
